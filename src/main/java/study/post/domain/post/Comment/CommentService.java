...
public class CommentService {
    ...
    public CommentDto write(Long postId, String nickname, String content) {
    ...
    public CommentDto modify(Long postId, String nickname, Long commentId, String content) {
    ...
    public void delete(Long postId, String nickname, Long commentId) {
        Comment comment = commentRepository.findById(commentId).orElseThrow(() -> new CommentNotFoundException("댓글을 찾을 수 없습니다."));
